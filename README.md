...
| devantech:supporteddevices | List all supported devices. |
| devantech:modules | List all devices and their activation status. |
| devantech:controlevents | 
...
October 2020
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwNjA0NDUyMSwtMTY1NDQ0NTU0NywtNj
