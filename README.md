...
| devantech:supporteddevices | Log a list all supported devices. |
| devantech:modules | Logist all configured modules and their activation status. |
...
October 2020
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM2OTYxMDg0NywtMTY1NDQ0NTU0NywtNj
